...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header">{{trans('layout.mainNavigation')}}</li>

            <li><a href="#"><i class="fa fa-circle-o text-blue"></i> <span>{{trans('layout.home')}}</span></a></li>

            <li><a href="/register"><i class="fa fa-circle-o text-blue"></i> <span>{{trans('register.register')}}</span></a></li>

            <li><a href="/login"><i class="fa fa-circle-o text-blue"></i> <span>{{trans('register.login')}}</span></a></li>
            ...
            {{--<li class="treeview">--}}
                {{--<a href="#">--}}
                    ...
                    {{--<span>{{trans('layout.inbox')}}</span>--}}
                    {{--<span class="pull-right-container">--}}
              {{--<span class="label label-primary pull-right">@yield('messageCount')</span>--}}
            {{--</span>--}}
                {{--</a>--}}
                {{--<ul class="treeview-menu">--}}
